# TODO
# maybe add a parameter to decide wheter or not to generate feature files
# or load them from file, so we don't need to (un)comment code 
...
base_dir = "/Users/benjaminglaus/Desktop/BA code/"
...
cnn_network = [['Conv', 'Conv', 'Pooling', 'Conv', 'Conv', 'Pooling']] #, ['Conv', 'Conv', 'Conv', 'Conv', 'Pooling']]
