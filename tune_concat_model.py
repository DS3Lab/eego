...
from sentiment import sentiment_concat_feats_model, sentiment_eeg_model, sentiment_text_eeg_model
                                                ...
                                                for inception_dense_dim in config.inception_dense_dim:
                                                    ...
                                                    if config.class_task == 'reldetect':
                                                        ...
                                                        if 'combi_concat' in config.feature_set:
                                                            ...
                                                            fold_results = sentiment_concat_feats_model.classifier(feature_dict,
                                                                                                                    label_dict,
                                                                                                                    eeg_dict,
                                                                                                                    config.embeddings,
                                                                                                                    parameter_dict,
